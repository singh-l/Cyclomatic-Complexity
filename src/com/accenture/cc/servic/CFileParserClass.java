...
public class CFileParserClass
{
  ...
  int     index       = 0, multicommentCount = 0, ifCount = 0, ifElseCount = 0, doWhileCount = 0, whileCount = 0,
          ...
          gotoCount = 0, labelCount = 0, macroSetJmpCount = 0, functioncount = 0, signalCount = 0, raiseCount = 0;
  ...
  public void collectTokens(String codeLine)
  {
    ...
    if (codeLine != null && !codeLine.equals(""))
    {
      ...
      if ((codeLine.matches(".*goto") || codeLine.matches("goto.*") || codeLine.matches("goto") || codeLine
              .matches(".*goto.*")) &&
          codeLine.matches(".*[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ]goto[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ].*") &&
          codeLine.matches("goto[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ].*") &&
          codeLine.matches(".*[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ]goto"))
      {
      ...
      else if (codeLine.matches("\\s+goto"))
      {
      ...
      else if (codeLine.matches("goto\\s+"))
      {
      ...
      if ((codeLine.matches("#.*setjmp") || codeLine.matches("setjmp.*") || codeLine.matches("setjmp") || codeLine
              .matches("#.*setjmp.*")) &&
          codeLine.matches(".*[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ]setjmp[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ].*") &&
          codeLine.matches("setjmp[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ].*") &&
          codeLine.matches(".*[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ]setjmp"))
      {
      ...
      else if (codeLine.matches("\\s+setjmp"))
      {
      ...
      else if (codeLine.matches("setjmp\\s+"))
      {
      ...
      if (!codeLine.contains(";") &&
          (codeLine.matches(".*void.*") || codeLine.matches(".*int.*") || codeLine.matches(".*double.*") ||
           codeLine.matches(".*char.*") || codeLine.matches(".*short.*") || codeLine.matches(".*long.*") ||
           codeLine.matches(".*float.*") || codeLine.matches(".*signed.*") || codeLine.matches(".*unsigned.*") ||
           codeLine.matches("void.*") || codeLine.matches("int.*") || codeLine.matches("double.*") ||
           codeLine.matches("char.*") || codeLine.matches("short.*") || codeLine.matches("long.*") ||
           codeLine.matches("float.*") || codeLine.matches("signed.*") || codeLine.matches("unsigned.*")) &&
          codeLine.matches(".*[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ]void[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ].*") &&
          codeLine.matches(".*[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ]int[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ].*") &&
          codeLine.matches(".*[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ]double[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ].*") &&
          codeLine.matches(".*[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ]char[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ].*") &&
          codeLine.matches(".*[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ]short[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ].*") &&
          codeLine.matches(".*[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ]long[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ].*") &&
          codeLine.matches(".*[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ]float[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ].*") &&
          codeLine.matches(".*[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ]signed[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ].*") &&
          codeLine.matches(".*[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ]unsigned[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ].*") &&
          codeLine.matches("void[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ].*") &&
          codeLine.matches("int[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ].*") &&
          codeLine.matches("double[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ].*") &&
          codeLine.matches("char[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ].*") &&
          codeLine.matches("short[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ].*") &&
          codeLine.matches("long[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ].*") &&
          codeLine.matches("float[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ].*") &&
          codeLine.matches("signed[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ].*") &&
          codeLine.matches("unsigned[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ].*"))
      {
      ...
      if ((codeLine.matches(".*signal\\s+\\(.*") || codeLine.matches(".*signal\\(.*")) &&
          codeLine.matches(".*[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ]signal[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ].*"))
      {
      ...
      if ((codeLine.matches(".*raise\\s+\\(.*") || codeLine.matches(".*raise\\(.*")) &&
          codeLine.matches(".*[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ]raise[^a-zA-Z0-9&_$%@#!^+-/*öüÄÖÜ].*"))
      {
  ...
  public ClassBO populateBo(ClassBO cls)
  {
    ...
    cls.setLabelCount(labelCount);
    cls.setSetJmpcount(macroSetJmpCount);
    cls.setFunctioncount(functioncount);
    cls.setSignalCount(signalCount);
    cls.setRaiseCount(raiseCount);
