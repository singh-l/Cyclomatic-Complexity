...
<th colspan="8" bgcolor="#A9BCF5">Conditional and Looping Statements</th>
...
<th bgcolor="#A9BCF5">Count of "BITWISE AND i.e '&' "
</th>
<th bgcolor="#A9BCF5">Count of "BITWISE OR i.e '|' ".
</th>
<th bgcolor="#A9BCF5">Count of "BITWISE XOR i.e. '^' "
</th>
<th bgcolor="#A9BCF5">Count of "CONDITIONAL AND i.e. &&"
</th>
<th bgcolor="#A9BCF5">Count of "CONDITIONAL OR i.e. ||"
</th>
...
i++;
 ...
 <td> <%if(clsbo. getBitwiseXor()>0)
  out.println(clsbo. getBitwiseXor());
  %>
  </td>
 <td>
 <%
